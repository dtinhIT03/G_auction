...
public interface ProductRepository extends JpaRepository<Product,Long>, ProductRepositoryCustom {
	...
	@Query(value =
       ...
       ORDER BY p.id desc
       """, nativeQuery = true)
	List<Object[]> findByOwnerIdNoPagination(@Param("o") Long ownerId, @Param("status") String status);
	...
	Integer countByOwnerIdAndStatus(Long ownerId, ProductStatus status);
}
